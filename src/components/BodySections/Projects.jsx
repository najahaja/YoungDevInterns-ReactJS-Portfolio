...
const Projects = () => {
  ...
  const videos = [
    ...
    { src: video2, title: "CartApp with React and Vite", demo:"https://najahaja.github.io/addCartApp/" ,source:"https://github.com/najahaja/addcart",lang :"JavaScript,CSS,HTML",tools:"React,vite,Webpack,Redux,React Router,Axios/Fetch"},
  ...
  return (
    ...
    >
      {videos.map((video, index) => (
        <div
          key={index}
          className="bg-black/50 relative rounded text-xl text-white cursor-pointer"
